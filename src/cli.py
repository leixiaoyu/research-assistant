...
def run(
    ...
    try:
        ...
        # 3. Process Topics
        asyncio.run(_process_topics(config, discovery_service, catalog_service, md_generator, config_manager))
    ...
    for topic in config.research_topics:
        try:
            ...
            run = CatalogRun(
                ...
                papers_processed=len(papers), # Phase 1: all found are "processed"
