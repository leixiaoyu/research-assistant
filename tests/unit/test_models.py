...
from src.models.config import (
    ResearchConfig, ResearchTopic, TimeframeRecent, 
    TimeframeSinceYear, TimeframeDateRange, GlobalSettings
)
...
def test_catalog_has_paper():
    from src.models.catalog import ProcessedPaper, CatalogRun
    catalog = Catalog()
    topic = catalog.get_or_create_topic("test-topic", "Test Query")
